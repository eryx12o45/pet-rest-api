...
INSERT INTO PET (ID, NAME, QUANTITY, CAT_ID) VALUES (NEXTVAL('S_PET'), 'Labrador chocolate', 3, 1);
INSERT INTO PET (ID, NAME, QUANTITY, CAT_ID) VALUES (NEXTVAL('S_PET'), 'Yellow bird', 2, 4);
